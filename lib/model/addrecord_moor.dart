...
class SnapExpenseDatabase extends _$SnapExpenseDatabase {
  ...
  Future insertRecords(Addrecord newrecord) =>
      into(addrecords).insert(newrecord);

  // Updates a Addrecords with a matching primary key
  Future updateRecords(Addrecord newrecord) =>
      update(addrecords).replace(newrecord);

  Future deleteRecords(Addrecord newrecord) =>
      delete(addrecords).delete(newrecord);
}
